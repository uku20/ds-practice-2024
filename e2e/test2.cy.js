// cypress/integration/multiple_non_fraudulent_non_conflicting_orders.spec.js
describe('Multiple Non-Fraudulent Non-Conflicting Orders', () => {
    const orders = [
        ...
        { book:'#root > div > div.flex-grow-1 > div > div:nth-child(5) > div > div.col-md-4.d-flex.justify-content-center.align-items-center > a',checkout:'#root > div > div.flex-grow-1 > div > div > div:nth-child(2) > button', name: 'Jane Smith', contact: '123456', street: '223 Main St', city: 'tartu', state:'tartu', zip:'51009', country:'Estonia', creditCard: '4111111112211111', date:'04/28', cvv: '225' }
    ];
    ...
    orders.forEach((order) => {
        it(`should create a non-conflicting order for ${order.name}`, () => {
            ...
            cy.log(`Non-fraudulent order created for ${order.name}`);
        });
    });
});
